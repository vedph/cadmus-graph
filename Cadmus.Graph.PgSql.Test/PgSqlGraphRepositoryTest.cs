...
namespace Cadmus.Graph.PgSql.Test;

[Collection(nameof(NonParallelResourceCollection))]
public sealed class PgSqlGraphRepositoryTest : SqlGraphRepositoryTest
{
    ...
    {
        PgSqlGraphRepository repository = new();
    ...
    protected override string GetSchema() => PgSqlGraphRepository.GetSchema();
