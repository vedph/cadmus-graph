...
c:\exe\nuget add .\Cadmus.Graph.Sql\bin\Debug\Cadmus.Graph.Sql.2.2.6.nupkg -source C:\Projects\_NuGet
c:\exe\nuget add .\Cadmus.Graph.MySql\bin\Debug\Cadmus.Graph.MySql.2.2.6.nupkg -source C:\Projects\_NuGet
